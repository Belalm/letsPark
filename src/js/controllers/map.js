...
controller('mapCtrl', ["$scope", "$state", "$stateParams", "$http",
    function($scope, $state, $stateParams, $http) {
        ...
        $scope.spots.Indoor.First[6][21] = true;
        $scope.spots.Indoor.First[6][11] = true;
        $scope.spots.Indoor.First[7][25] = true;
        $scope.spots.Indoor.First[7][29] = true;
        $scope.spots.Indoor.First[7][22] = true;
        $scope.spots.Indoor.First[7][21] = true;
        ...
        $scope.spots.Indoor.Second[4][30] = true;

        $scope.spots.Indoor.Second[9][2] = true;
        $scope.spots.Indoor.Second[5][6] = true;
        $scope.spots.Indoor.Second[8][4] = true;

        $scope.spots.Indoor.Second[6][10] = false;
        $scope.spots.Indoor.Second[2][10] = false;
        $scope.spots.Indoor.Second[5][4] = true;
        ...
        $scope.spots.Indoor.Second[6][21] = true;
        $scope.spots.Indoor.Second[6][11] = true;
        $scope.spots.Indoor.Second[8][25] = true;
        $scope.spots.Indoor.Second[7][29] = true;
        $scope.spots.Indoor.Second[7][22] = true;
        $scope.spots.Indoor.Second[7][21] = true;
        $scope.spots.Indoor.Second[7][30] = true;

        $scope.spots.Indoor.Second[5][4] = true;
        $scope.spots.Indoor.Second[10][6] = true;
        $scope.spots.Indoor.Second[9][20] = true;
        $scope.spots.Indoor.Second[8][25] = true;
        $scope.spots.Indoor.Second[6][26] = true;
        $scope.spots.Indoor.Second[6][30] = true;

        $scope.spots.Indoor.Second[9][2] = true;
        $scope.spots.Indoor.Second[9][6] = true;
